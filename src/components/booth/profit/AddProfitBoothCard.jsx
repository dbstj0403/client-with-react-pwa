...
import usePostProfitBooths from '@/query/post/usePostProfitBooths';
import PropTypes from 'prop-types';
import React, { useEffect, useState } from 'react';
import styled from 'styled-components';

AddProfitBoothCard.propTypes = {
  closeForm: PropTypes.func,
};

/**
 * @param {func} onClickDelete: 삭제 버튼 누르면 카드 추가 form 사라짐
 */
export default function AddProfitBoothCard({ closeForm }) {
  /** 수익 부스 추가 리퀘스트 */
  ...
  const { addProfitBooth, isError } = usePostProfitBooths();
